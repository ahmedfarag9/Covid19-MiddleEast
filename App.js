...
function Tabs3Arabic(props) {
  return (
    ...
    >
      <Tab3Arabic.Screen
        name="GraphScreen1Arabic"
        component={GraphScreen1Arabic}
        initialParams={props.route.params}        
        options={{
          tabBarLabel: 'اجمالى الاصابات',
          tabBarIcon: ({ color, size }) => (
            <MaterialCommunityIcons name="settings-helper" color={color} size={size} />
          ),
        }}
      />
      <Tab3Arabic.Screen
        name="GraphScreen2Arabic"
        component={GraphScreen2Arabic}
        initialParams={props.route.params}        
        options={{
          tabBarLabel: 'الاصابات الجديدة',
          tabBarIcon: ({ color, size }) => (
            <MaterialCommunityIcons name="settings-helper" color={color} size={size} />
          ),
        }}
      />
      <Tab3Arabic.Screen
        name="GraphScreen3Arabic"
        component={GraphScreen3Arabic}
        initialParams={props.route.params}        
        options={{
          tabBarLabel: 'اجمالى الوفيات',
          tabBarIcon: ({ color, size }) => (
            <MaterialCommunityIcons name="settings-helper" color={color} size={size} />
          ),
        }}
